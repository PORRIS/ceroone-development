      ...
      <div class="py-4 text-gray-500">
        ...
        <ul class="mt-6">
          <li class="relative px-6 py-3">
            <ResponsiveNavLink :href="route('Ceroone')" :active="route().current('Ceroone')">
              <template #icon>
          ...
          <li class="relative px-6 py-3">
            ...
            <li class="relative px-6 py-3">
                <NavLink :href="route('accounting-accounts.index')" :active="route().current('accounting-accounts.index')">
                    <template #icon>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-5 h-5">
