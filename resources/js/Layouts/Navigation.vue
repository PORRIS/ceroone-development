<template>
  <aside class="z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0 bg-amber-50">
    <div class="py-4 text-gray-500">
      <Link class="ml-6 text-lg font-bold text-gray-800" :href="route('Ceroone')">
          <img width="300" height="73"
               src="https://ceroone.com/wp-content/uploads/2020/09/logo-ceroone-web-sin-fondo.png" class="m-0" alt="" decoding="async">
      </Link>

      <ul class="mt-6">
        <li class="relative px-6 py-3">
          <NavLink :href="route('Ceroone')" :active="route().current('Ceroone')">
            <template #icon>
